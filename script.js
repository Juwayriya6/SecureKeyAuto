...
document.querySelectorAll("form").forEach(form => {
  form.addEventListener("submit", event => {
    ...
    window.location.href = `mailto:service@securekeyauto.com?subject=${subject}&body=${lines || "New service request"}`;
  });
});
...
const responses = [
  "For immediate help, tap the Call 24/7 button. For a quote, send your vehicle make, model, year and location.",
  ...
  "For production, this assistant can be connected to a real AI/chat backend."
];
